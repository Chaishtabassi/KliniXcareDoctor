...
const Messagepatient = ({route}) => {
    ...
    const sendMessageToApi = async (text) => {
      try {
        ...
        formData.append('patient_id', selectedpatien.user_id);
        formData.append('doctor_id', selectedpatien.doctor_id);
    ...
    return (
      ...
      <View style={styles.header}>
        <Backbutton />
       <Text style={styles.title}>{selectedpatien.user.fullname}</Text>
      </View>
      {loading ? (
