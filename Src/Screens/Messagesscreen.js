...
const Messagesscreen = ({navigation,route}) => {
  ...
  const sendMessageToApi = async (text) => {
    try {
      ...
      formData.append('patient_id', item.last_chat.user_id);
      formData.append('doctor_id', item.last_chat.doctor_id);
      formData.append('sender_type', 'doctor');
      formData.append('appointment_id', item.last_chat.appointment_id);
